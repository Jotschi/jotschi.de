...
excerpt: "For my project <a href=\"http://www.jotschi.de/?page_id=320\">Generating City Models By Using Panorama Images</a> i have to write a fragment shader that handles multiple projections onto the same surface. The shader must contain condition in which the projection should be handled. In my case i had to decide which projection source should be used to texture the desired model. "
wordpress_id: 363
wordpress_url: /?p=363
date: 2009-08-17 23:20:56 +00:00
categories: 
- Technik
- GFX
tags: 
...
- id: 1417
  ...
  content: |-
    ...
    I'll look into that soon when i finish my scene graph datastructure for my project.
---
