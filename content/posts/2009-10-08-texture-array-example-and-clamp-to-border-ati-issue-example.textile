...
wordpress_id: 396
wordpress_url: /?p=396
date: 2009-10-08 22:00:39 +00:00
categories: 
- Technik
- GFX
tags: 
...
<blockquote>apt-get install libglut3 libglut3-dev libglew1.5 libglew1.5-dev</blockquote>
...
<strong>NOARRAY - not definied</strong>
...
<strong>NOARRAY - definied</strong>
...
<strong>shader_array.frag:</strong>
<pre class="syntax c">
uniform sampler2DArray base_texture;
varying vec2 texCoord;
void main()
...
<strong>shader_simple.frag:</strong>
<pre class="syntax c">
...
<strong>Simple_ATI_TEXTURE_2D_ARRAY_Example.cpp:</strong>
<pre class="syntax c">
#include <GL/glew.h>
#include <GL/gl.h>
#include <GL/glut.h>
