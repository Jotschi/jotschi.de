...
wordpress_id: 254
wordpress_url: /?p=254
date: 2009-02-21 23:00:20 +00:00
categories: 
- Fundgrube
- Technik
tags: 
...
- id: 1331
  ...
  content: |-
    Hi, i just added the demo online version. 
    <a href="/downloads/ajax_clipping/test.html" rel="nofollow">Demo</a>
    
    1. Inclusion of basic javascript functions inside of the clipped pages should be possible but i haven't tested this extensivly.
    2. Links will just work fine as long as they point to the same host.
---
Including a page into your own website using frames is no big deal. But what will you do when you don't want to use iframes? Well you could use Ajax :)
